 ...
 */
@Entity
@Table(name = "ent_per_relation_type", schema = "public", catalog = "remonditeenus")
public class EntPerRelationTypeEntity {
    private int entPerRelationType;
    private String typeName;

    @Id
    @Column(name = "ent_per_relation_type", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    public boolean equals(Object o) {
        ...
        EntPerRelationTypeEntity that = (EntPerRelationTypeEntity) o;
