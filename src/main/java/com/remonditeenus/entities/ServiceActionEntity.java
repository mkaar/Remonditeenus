 ...
 */
@Entity
@Table(name = "service_action", schema = "public", catalog = "remonditeenus")
public class ServiceActionEntity {
    ...
    @Id
    @Column(name = "service_action", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_action_status_type_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_type_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_device_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_amount", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "price_updated", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "action_description", nullable = true, insertable = true, updatable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "created_by", nullable = true, insertable = true, updatable = true, precision = 0)
