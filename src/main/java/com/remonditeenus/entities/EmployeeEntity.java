 ...
 */
@Entity
@Table(name = "employee", schema = "public", catalog = "remonditeenus")
public class EmployeeEntity {
    ...
    @Id
    @Column(name = "employee", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "struct_unit_fk", nullable = true, insertable = true, updatable = true, precision = 0)
