 ...
 */
@Entity
@Table(name = "invoice_row", schema = "public", catalog = "remonditeenus")
public class InvoiceRowEntity {
    ...
    @Id
    @Column(name = "invoice_row", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "invoice_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_action_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_part_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "action_part_description", nullable = true, insertable = true, updatable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "unit_type", nullable = true, insertable = true, updatable = true, length = 200)
    ...
    @Basic
    @Column(name = "invoice_row_type", nullable = true, insertable = true, updatable = true, precision = 0)
