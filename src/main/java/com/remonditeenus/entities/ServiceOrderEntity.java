 ...
 */
@Entity
@Table(name = "service_order", schema = "public", catalog = "remonditeenus")
public class ServiceOrderEntity {
    ...
    @Id
    @Column(name = "service_order", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "so_status_type_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_request_fk", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "updated_by", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "status_changed_by", nullable = true, insertable = true, updatable = true, precision = 0)
