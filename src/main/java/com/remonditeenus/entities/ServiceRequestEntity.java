 ...
 */
@Entity
@Table(name = "service_request", schema = "public", catalog = "remonditeenus")
public class ServiceRequestEntity {
    ...
    @Id
    @Column(name = "service_request", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "service_desc_by_customer", nullable = true, insertable = true, updatable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "service_desc_by_employee", nullable = true, insertable = true, updatable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "service_request_status_type_fk", nullable = true, insertable = true, updatable = true, precision = 0)
