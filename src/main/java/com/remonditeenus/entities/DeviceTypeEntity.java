 ...
 */
@Entity
@Table(name = "device_type", schema = "public", catalog = "remonditeenus")
public class DeviceTypeEntity {
    ...
    @Id
    @Column(name = "device_type", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "super_type_fk", nullable = true, insertable = true, updatable = true, precision = 0)
