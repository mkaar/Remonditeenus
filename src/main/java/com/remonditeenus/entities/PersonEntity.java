 ...
 */
@Entity
@Table(name = "person", schema = "public", catalog = "remonditeenus")
public class PersonEntity {
    ...
    @Id
    @Column(name = "person", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "identity_code", nullable = true, insertable = true, updatable = true, length = 20)
