 ...
 */
@Entity
@Table(name = "user_account", schema = "public", catalog = "remonditeenus")
public class UserAccountEntity {
    ...
    @Id
    @Column(name = "user_account", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "passw", nullable = true, insertable = true, updatable = true, length = 300)
    ...
    @Basic
    @Column(name = "valid_from", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "valid_to", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "password_never_expires", nullable = true, insertable = true, updatable = true, length = 1)
