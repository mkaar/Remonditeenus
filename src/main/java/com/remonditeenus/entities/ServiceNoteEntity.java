 ...
 */
@Entity
@Table(name = "service_note", schema = "public", catalog = "remonditeenus")
public class ServiceNoteEntity {
    ...
    @Id
    @Column(name = "service_note", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "note_author_type", nullable = true, insertable = true, updatable = true, precision = 0)
