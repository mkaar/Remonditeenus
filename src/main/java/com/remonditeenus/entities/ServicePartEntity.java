 ...
 */
@Entity
@Table(name = "service_part", schema = "public", catalog = "remonditeenus")
public class ServicePartEntity {
    ...
    @Id
    @Column(name = "service_part", nullable = false, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "part_name", nullable = true, insertable = true, updatable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "serial_no", nullable = true, insertable = true, updatable = true, length = 2147483647)
    ...
    @Basic
    @Column(name = "part_count", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "part_price", nullable = true, insertable = true, updatable = true, precision = 0)
