 ...
 */
@Entity
@Table(name = "service_device_status_type", schema = "public", catalog = "remonditeenus")
public class ServiceDeviceStatusTypeEntity {
    private int serviceDeviceStatusType;
    private String typeName;

    @Id
    @Column(name = "service_device_status_type", nullable = false, insertable = true, updatable = true, precision = 0)
